...
現行の `BIZ_PROTO_BASE_URL` は `https://biz-prototypes-viewer-u562wnlrda-an.a.run.app` です。
...
利用者はGoogleログインだけでアクセスします。ページ内パスワードは使いません。
...
| 使う人 | 正規ルート | 完了時 |
|--------|------------|--------|
| GitHubへpushできる人 | 自分でGitHubに追加してpushし、URLをゆーちゃんに渡して通知依頼する | ゆーちゃんがSlackで登録通知とURL再掲をする |
...
```
URL: https://biz-prototypes-viewer-u562wnlrda-an.a.run.app/agency/
許可ドメイン: ayudante.jp
```
